...
--
-- Keybinds for Colemak HJKL equivalent (Alt+N,E,I,O)
vim.keymap.set({ 'n', 'o', 'x' }, '<M-n>', 'h', { desc = "Colemak version of 'h'", noremap = true, silent = true })
vim.keymap.set({ 'n', 'o', 'x' }, '<M-e>', 'j', { desc = "Colemak version of 'j'", noremap = true, silent = true })
...
require('lazy').setup({
  ...
  { -- LSP Configuration & Plugins
    ...
    config = function()
      ...
      vim.list_extend(ensure_installed, {
        ...
        'shellcheck',
        'prettier', -- Formatting YAML, JSON, & others
      })
  ...
  { -- Highlight, edit, and navigate code
    ...
    build = ':TSUpdate',
    opts = {
      ensure_installed = { 'bash', 'c', 'diff', 'elixir', 'erlang', 'html', 'lua', 'luadoc', 'markdown', 'vim', 'vimdoc' },
